...
def get_files(save_dir, sleep_time, delete=True, debug=False, name_in_url=False, try_overwite=False, domain_included=False, no_overwrite=False, add_date=False):
