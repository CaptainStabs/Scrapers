...
def list_pdf_v3(configs, save_dir, debug=False, important=False, try_overwite=False, name_in_url=True, add_date=False): # try_overwite is for get_files
    ...
    get_files(save_dir, configs.sleep_time, debug=debug, try_overwite=try_overwite, name_in_url=name_in_url, add_date=add_date)
